...
#ifndef _HUGE
  extern double * __IMP_SYMBOL(_HUGE);
# define _HUGE (* __IMP_SYMBOL(_HUGE))
#endif
...
# define __setusermatherr __mingw_setusermatherr
  ...
  _CRTIMP double __cdecl ceil(double _X) __CONST;
  _CRTIMP double __cdecl floor(double _X) __CONST;
          double __cdecl fabs(double _X) __CONST;
...
# define _CRT_ABS_DEFINED
  int  __cdecl abs(int _X)   __NOTHROW __CONST __WUR_FORTIFY;
  long __cdecl labs(long _X) __NOTHROW __CONST __WUR_FORTIFY;
# if defined(__MINGW_USE_ISOC99) || defined(__MINGW_USE_C99FORGXX)
    __MINGW_EXTENSION long long __cdecl llabs(long long _X) __NOTHROW __CONST __WUR_FORTIFY;
# endif
...
#define FP_PNORM   _FPCLASS_PN
  ...
  extern int __cdecl isnan(double _X) __CONST;
...
# endif
  ...
  extern int __cdecl isnanf(float _X)       __CONST;
  extern int __cdecl isnanl(long double _X) __CONST;
...
*/
  extern int __cdecl __fpclassify(double _X)       __CONST;
  extern int __cdecl __fpclassifyf(float _X)       __CONST;
  extern int __cdecl __fpclassifyl(long double _X) __CONST;
...
/* We don't need to worry about truncation here:
   A NaN stays a NaN. */
  extern int __cdecl __isnan(double _X)       __CONST;
  extern int __cdecl __isnanf(float _X)       __CONST;
  extern int __cdecl __isnanl(long double _X) __CONST;
...
/* 7.12.3.6 The signbit macro */
  ...
  extern int __cdecl __signbitf(float _X)       __CONST;
  extern int __cdecl __signbitl(long double _X) __CONST;
...
#define FP_ILOGBNAN ((int)0x7fffffff)
  ...
  _CRTIMP int __cdecl ilogbl(long double _X);
...
/* 7.12.6.7 Double in C89 */
  ...
  _CRTIMP long double __cdecl logl(long double _X);

/* 7.12.6.8 Double in C89 */
  _CRTIMP float       __cdecl log10f(float _X);
  _CRTIMP long double __cdecl log10l(long double _X);

/* 7.12.6.9 */
  _CRTIMP double      __cdecl log1p(double _X);
  _CRTIMP float       __cdecl log1pf(float _X);
  _CRTIMP long double __cdecl log1pl(long double _X);
...
/* 7.12.7.3  */
  ...
  _CRTIMP long double __cdecl hypotl(long double _X, long double _Y);

/* 7.12.7.4 The pow functions. Double in C89 */
  _CRTIMP float       __cdecl powf(float _X, float _Y);
  _CRTIMP long double __cdecl powl(long double _X, long double _Y);

/* 7.12.7.5 The sqrt functions. Double in C89. */
  _CRTIMP float       __cdecl sqrtf(float _X);
  _CRTIMP long double __cdecl sqrtl(long double _X);

/* 7.12.8.1 The erf functions  */
  _CRTIMP double      __cdecl erf(double _X);
  _CRTIMP float       __cdecl erff(float _X);
  _CRTIMP long double __cdecl erfl(long double _X);

/* 7.12.8.2 The erfc functions  */
  _CRTIMP double      __cdecl erfc(double _X);
  _CRTIMP float       __cdecl erfcf(float _X);
  _CRTIMP long double __cdecl erfcl(long double _X);
...
/* 7.12.8.4 The tgamma functions */
  ...
  _CRTIMP long double __cdecl tgammal(long double _X);

/* 7.12.9.1 Double in C89 */
  _CRTIMP float       __cdecl ceilf(float _X)       __CONST;
  _CRTIMP long double __cdecl ceill(long double _X) __CONST;

/* 7.12.9.2 Double in C89 */
  _CRTIMP float       __cdecl floorf(float _X)       __CONST;
  _CRTIMP long double __cdecl floorl(long double _X) __CONST;

/* 7.12.9.3 */
  _CRTIMP double      __cdecl nearbyint(double _X);
  _CRTIMP float       __cdecl nearbyintf(float _X);
  _CRTIMP long double __cdecl nearbyintl(long double _X);

/* 7.12.9.4 */
/* round, using fpu control word settings */
  _CRTIMP double      __cdecl rint(double _X);
  _CRTIMP float       __cdecl rintf(float _X);
  _CRTIMP long double __cdecl rintl(long double _X);

/* 7.12.9.5 */
  _CRTIMP long __cdecl lrint(double _X);
  _CRTIMP long __cdecl lrintf(float _X);
  _CRTIMP long __cdecl lrintl(long double _X);

  __MINGW_EXTENSION _CRTIMP long long __cdecl llrint(double _X);
  __MINGW_EXTENSION _CRTIMP long long __cdecl llrintf(float _X);
  __MINGW_EXTENSION _CRTIMP long long __cdecl llrintl(long double _X);

/* 7.12.9.6 */
/* round away from zero, regardless of fpu control word settings */
  _CRTIMP double      __cdecl round(double _X)       __CONST;
  _CRTIMP float       __cdecl roundf(float _X)       __CONST;
  _CRTIMP long double __cdecl roundl(long double _X) __CONST;

/* 7.12.9.7  */
                    _CRTIMP long      __cdecl lround(double _X);
                    _CRTIMP long      __cdecl lroundf(float _X);
                    _CRTIMP long      __cdecl lroundl(long double _X);
  ...
  __MINGW_EXTENSION _CRTIMP long long __cdecl llroundl(long double _X);

/* 7.12.9.8 */
/* round towards zero, regardless of fpu control word settings */
  _CRTIMP double      __cdecl trunc(double _X)       __CONST;
  _CRTIMP float       __cdecl truncf(float _X)       __CONST;
  _CRTIMP long double __cdecl truncl(long double _X) __CONST;

/* 7.12.10.1 Double in C89 */
  _CRTIMP float       __cdecl fmodf(float _X, float _Y);
  _CRTIMP long double __cdecl fmodl(long double _X, long double _Y);

/* 7.12.10.2 */
  _CRTIMP double      __cdecl remainder(double _X, double _Y);
  _CRTIMP float       __cdecl remainderf(float _X, float _Y);
  _CRTIMP long double __cdecl remainderl(long double _X, long double _Y);
...
/* 7.12.11.2 Return a NaN */
  ...
  _CRTIMP long double __cdecl nanl(const char *_X);
...
/* 7.12.11.3 */
  _CRTIMP double      __cdecl nextafter(double _X, double _Y)            __NOTHROW __CONST;
  _CRTIMP float       __cdecl nextafterf(float _X, float _Y)             __NOTHROW __CONST;
  _CRTIMP long double __cdecl nextafterl(long double _X, long double _Y) __NOTHROW __CONST;

/* 7.12.11.4 The nexttoward functions */
  _CRTIMP double      __cdecl nexttoward(double _X, long double _Y)       __NOTHROW __CONST;
  _CRTIMP float       __cdecl nexttowardf(float _X,  long double _Y)      __NOTHROW __CONST;
  _CRTIMP long double __cdecl nexttowardl(long double _X, long double _Y) __NOTHROW __CONST;

/* 7.12.12.1 */
/*  x > y ? (x - y) : 0.0  */
  _CRTIMP double      __cdecl fdim(double _X, double _Y);
  _CRTIMP float       __cdecl fdimf(float _X, float _Y);
  _CRTIMP long double __cdecl fdiml(long double _X, long double _Y);
...
/* 7.12.12.2 */
  _CRTIMP double      __cdecl fmax(double _X, double _Y)            __CONST;
  _CRTIMP float       __cdecl fmaxf(float _X, float _Y)             __CONST;
  _CRTIMP long double __cdecl fmaxl(long double _X, long double _Y) __CONST;

/* 7.12.12.3 */
  _CRTIMP double      __cdecl fmin(double _X, double _Y)            __CONST;
  _CRTIMP float       __cdecl fminf(float _X, float _Y)             __CONST;
  _CRTIMP long double __cdecl fminl(long double _X, long double _Y) __CONST;

/* 7.12.13.1 */
/* return x * y + z as a ternary op */
  _CRTIMP double      __cdecl fma(double _X, double _Y, double _Z);
  _CRTIMP float       __cdecl fmaf(float _X, float _Y, float _Z);
  _CRTIMP long double __cdecl fmal(long double _X, long double _Y, long double _Z);
...
# define iszero(_X) (((__typeof__(_X))(_X)) == 0)
  ...
  extern double      __cdecl asinpi(double _X);
  extern float       __cdecl asinpif(float _X);
  extern long double __cdecl asinpil(long double _X);

  extern double      __cdecl atanpi(double _X);
  extern float       __cdecl atanpif(float _X);
  extern long double __cdecl atanpil(long double _X);

  extern double      __cdecl atan2pi(double _Y, double _X);
  ...
  extern double      __cdecl sinpi(double _X);
  extern float       __cdecl sinpif(float _X);
  extern long double __cdecl sinpil(long double _X);

  extern double      __cdecl tanpi(double _X);
  ...
  extern long double __cdecl log10p1l(long double _X);

  /**/   double      __cdecl logp1(double _X);
  /**/   float       __cdecl logp1f(float _X);
  /**/   long double __cdecl logp1l(long double _X);

  extern double      __cdecl log2p1(double _X);
  extern float       __cdecl log2p1f(float _X);
  extern long double __cdecl log2p1l(long double _X);

  extern double      __cdecl rsqrt(double _X);
  extern float       __cdecl rsqrtf(float _X);
  extern long double __cdecl rsqrtl(long double _X);
