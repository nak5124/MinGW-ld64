...
#ifdef __MINGW_USE_ISOC11
  int __cdecl timespec_get(struct timespec* _Ts, int _Base)
    __MINGW_ASM_CALL(_timespec64_get) __MINGW_NONNULL((1)) __MINGW_NOTHROW;
#endif
#ifdef __MINGW_USE_SECAPI
...
# define _TIMEZONE_DEFINED
  ...
  extern int __cdecl mingw_gettimeofday(struct timeval *p, struct timezone *z) __MINGW_NONNULL((1)) __MINGW_NOTHROW;
