...
#define _iswcsym_l(_c, _p)  (_iswalnum_l(_c, _p) || ((_c)=='_'))
  ...
  _CRTIMP int __cdecl isascii(int _C) __NOTHROW __MINGW_DEPRECATED_MSVC2005;
  _CRTIMP int __cdecl toascii(int _C) __NOTHROW __MINGW_DEPRECATED_MSVC2005;
