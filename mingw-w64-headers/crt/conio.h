...
__MINGW_BEGIN_C_DECLS
  ...
  __mingw_ovr int _vcprintf_l(const char * __restrict _Format, _locale_t _Locale, va_list _ArgList)
  {
    return __conio_common_vcprintf(0, _Format, _Locale, _ArgList);
  }

  __mingw_ovr int _vcprintf(const char * __restrict _Format, va_list _ArgList)
  {
    return __conio_common_vcprintf(0, _Format, NULL, _ArgList);
  }

  __mingw_ovr int _vcprintf_s_l(const char * __restrict _Format, _locale_t _Locale, va_list _ArgList)
  {
    return __conio_common_vcprintf_s(0, _Format, _Locale, _ArgList);
  }

  __mingw_ovr int _vcprintf_s(const char * __restrict _Format, va_list _ArgList)
  {
    return __conio_common_vcprintf_s(0, _Format, NULL, _ArgList);
  }

  __mingw_ovr int _vcprintf_p_l(const char * __restrict _Format, _locale_t _Locale, va_list _ArgList)
  {
    return __conio_common_vcprintf_p(0, _Format, _Locale, _ArgList);
  }

  __mingw_ovr int _vcprintf_p(const char * __restrict _Format, va_list _ArgList)
  {
    return __conio_common_vcprintf_p(0, _Format, NULL, _ArgList);
  }

  __mingw_ovr int _cprintf_l(const char * __restrict _Format, _locale_t _Locale, ...)
  {
  ...
  __mingw_ovr int _cprintf(const char * __restrict _Format, ...)
  {
    __builtin_va_list _ArgList;
    int _Ret;
  ...
  __mingw_ovr int _cprintf_s_l(const char * __restrict _Format, _locale_t _Locale, ...)
  {
    __builtin_va_list _ArgList;
    int _Ret;
    __builtin_va_start(_ArgList, _Format);
  ...
  __mingw_ovr int _cprintf_s(const char * __restrict _Format, ...)
  {
    __builtin_va_list _ArgList;
    int _Ret;
    __builtin_va_start(_ArgList, _Format);
  ...
  __mingw_ovr int _cprintf_p_l(const char * __restrict _Format, _locale_t _Locale, ...)
  {
    __builtin_va_list _ArgList;
    int _Ret;
    __builtin_va_start(_ArgList, _Locale);
  ...
  __mingw_ovr int _cprintf_p(const char * __restrict _Format, ...)
  {
    __builtin_va_list _ArgList;
    int _Ret;
    __builtin_va_start(_ArgList, _Format);
  ...
  __mingw_ovr int _vcscanf_s_l(const char * __restrict _Format, _locale_t _Locale, va_list _ArgList)
  {
    return __conio_common_vcscanf(_CRT_INTERNAL_SCANF_SECURECRT, _Format, _Locale, _ArgList);
  }

  __mingw_ovr int _vcscanf_s(const char * __restrict _Format, va_list _ArgList)
  {
  ...
  __mingw_ovr int _cscanf_s_l(const char * __restrict _Format, _locale_t _Locale, ...)
  {
    __builtin_va_list _ArgList;
    int _Ret;
    __builtin_va_start(_ArgList, _Format);
  ...
  __mingw_ovr int _cscanf_s(const char * __restrict _Format, ...)
  {
    __builtin_va_list _ArgList;
    int _Ret;
    __builtin_va_start(_ArgList, _Format);
