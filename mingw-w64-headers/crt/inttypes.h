...
#define SCNuFAST8  "hhu"
  ...
  _CRTIMP intmax_t __cdecl imaxabs(intmax_t j) __MINGW_CONST __MINGW_NOTHROW;
  _CRTIMP imaxdiv_t __cdecl imaxdiv(intmax_t numer, intmax_t denom) __MINGW_CONST __MINGW_NOTHROW;
