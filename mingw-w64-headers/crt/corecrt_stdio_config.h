...
#if defined(_CRT_STDIO_ISO_WIDE_SPECIFIERS) && defined(_CRT_STDIO_LEGACY_WIDE_SPECIFIERS)
...
#   define _CRT_INTERNAL_LOCAL_PRINTF_OPTIONS _CRT_INTERNAL_PRINTF_STANDARD_ROUNDING
# else
#   define _CRT_INTERNAL_LOCAL_PRINTF_OPTIONS _CRT_INTERNAL_PRINTF_STANDARD_ROUNDING | _CRT_INTERNAL_PRINTF_LEGACY_WIDE_SPECIFIERS
# endif
#endif
