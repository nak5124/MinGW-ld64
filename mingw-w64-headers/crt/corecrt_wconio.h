...
# define WEOF ((wint_t)(0xFFFF))
  ...
  _CRTIMP wchar_t *__cdecl _cgetws(wchar_t *_Buffer) __MINGW_DEPRECATED_SEC_WARN;
  ...
  __mingw_ovr
  int _vcwscanf_s_l(const wchar_t *__restrict _Format, _locale_t _Locale, va_list _ArgList)
  {
    return __conio_common_vcwscanf(_CRT_INTERNAL_LOCAL_SCANF_OPTIONS | _CRT_INTERNAL_SCANF_SECURECRT, _Format, _Locale, _ArgList);
  }

  __mingw_ovr
  int _vcwscanf_s(const wchar_t *__restrict _Format, va_list _ArgList)
  {
