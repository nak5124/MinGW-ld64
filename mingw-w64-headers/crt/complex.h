...
# define CMPLXL(x, y) __builtin_complex((long double)(x), (long double)(y))
  ...
  extern double          carg(double _Complex _Z) __CONST;
  ...
  extern double          cimag(double _Complex _Z) __CONST;
...
#endif
  extern double _Complex conj(double _Complex _Z) __CONST;
  extern double _Complex cpow(double _Complex _X, double _Complex _Y);
  extern double _Complex cproj(double _Complex _Z) __CONST;
  extern double          creal(double _Complex _Z) __CONST;
  ...
  extern float          cimagf(float _Complex _Z) __CONST;
  extern float _Complex clogf(float _Complex _Z);
#if defined(__MINGW_USE_GNU) || defined(__MINGW_USE_MS)
  extern float _Complex clog10f(float _Complex _Z);
#endif
  extern float _Complex conjf(float _Complex _Z) __CONST;
  extern float _Complex cpowf(float _Complex _X, float _Complex _Y);
  extern float _Complex cprojf(float _Complex _Z) __CONST;
  extern float          crealf(float _Complex _Z) __CONST;
  ...
  extern long double          cimagl(long double _Complex _Z) __CONST;
  extern long double _Complex clogl(long double _Complex _Z);
#if defined(__MINGW_USE_GNU) || defined(__MINGW_USE_MS)
  extern long double _Complex clog10l(long double _Complex _Z);
#endif
  extern long double _Complex conjl(long double _Complex _Z) __CONST;
  extern long double _Complex cpowl(long double _Complex _X, long double _Complex _Y);
  extern long double _Complex cprojl(long double _Complex _Z) __CONST;
  extern long double          creall(long double _Complex _Z) __CONST;
