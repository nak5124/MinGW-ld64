...
# define _CHMOD_UMASK_DEFINED
  ...
  _CRTIMP int      __cdecl _creat(const char *_Filename, int _PermissionMode) __MINGW_NONNULL((1)) __MINGW_DEPRECATED_SEC_WARN;
...
# endif
  ...
  _CRTIMP int      __cdecl _open(const char *_Filename, int _OpenFlag, ...) __MINGW_NONNULL((1)) __MINGW_DEPRECATED_SEC_WARN;
  ...
  extern  int   __cdecl access(const char *_Filename, int _AccessMode) __MINGW_NONNULL((1)) __MINGW_DEPRECATED_MSVC2005;
#ifdef __MINGW_USE_MS
  ...
  _CRTIMP int   __cdecl creat(const char *_Filename, int _PermissionMode) __MINGW_NONNULL((1)) __MINGW_DEPRECATED_MSVC2005 __MINGW_DEPRECATED_SEC_WARN;
  _CRTIMP int   __cdecl dup(int _FileHandle) __MINGW_DEPRECATED_MSVC2005;
  _CRTIMP int   __cdecl dup2(int _FileHandleSrc, int _FileHandleDst) __MINGW_DEPRECATED_MSVC2005;
#ifdef __MINGW_USE_MS
...
#endif
  _CRTIMP int   __cdecl isatty(int _FileHandle) __MINGW_DEPRECATED_MSVC2005;
#ifdef __MINGW_USE_MS
  ...
  _CRTIMP long  __cdecl lseek(int _FileHandle, long _Offset, int _Origin) __MINGW_DEPRECATED_MSVC2005;
#else
  ...
  _CRTIMP char *__cdecl mktemp(char *_TemplateName) __MINGW_NONNULL((1)) __MINGW_NOTHROW __MINGW_DEPRECATED_MSVC2005 __MINGW_DEPRECATED_SEC_WARN;
#endif
...
#endif
  _CRTIMP int   __cdecl write(int _Filehandle, const void *_Buf, unsigned int _MaxCharCount) __MINGW_DEPRECATED_MSVC2005;
...
#define _O_CREAT 0x0100
  ...
  _CRTIMP int __cdecl __mingw_call__open_warn_toomany(const char *_Filename, int _OpenFlag, ...)
    __MINGW_ASM_CRT_CALL(_open) __attribute__((__warning__("_open(): too many arguments")));
  _CRTIMP int __cdecl __mingw_call__open_warn_missing(const char *_Filename, int _OpenFlag, ...)
    __MINGW_ASM_CRT_CALL(_open) __attribute__((__warning__("_open(..._O_CREAT...): missing argument")));
  ...
  _CRTIMP int __cdecl __mingw_call__sopen_warn_toomany(const char *_Filename, int _OpenFlag, int _ShareFlag, ...)
    __MINGW_ASM_CRT_CALL(_sopen) __attribute__((__warning__("_sopen(): too many arguments")));
  _CRTIMP int __cdecl __mingw_call__sopen_warn_missing(const char *_Filename, int _OpenFlag, int _ShareFlag, ...)
    __MINGW_ASM_CRT_CALL(_sopen) __attribute__((__warning__("_sopen(..._O_CREAT...): missing argument")));
  ...
  off64_t __cdecl lseek64(int __fd, off64_t __offset, int __whence);
#endif

#if defined(__MINGW_USE_POSIX) || defined(__MINGW_USE_XOPEN)
  extern char *__cdecl getlogin(void);
# ifdef __USE_MINGW_ALARM
    extern unsigned int __cdecl alarm(unsigned int __seconds) __MINGW_NOTHROW;
# endif
#endif
