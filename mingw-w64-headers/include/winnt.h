...
# ifndef __WIDL__
#   define DECLSPEC_DEPRECATED __ATTR_DEPRECATED
...
# define ___GROUP_AFFINITY_DEFINED
  ...
  {
    __MINGW_EXTENSION unsigned __int64 Mask;
    WORD                               Group;
    WORD                               Reserved[3];
...
# define STDOVERRIDEMETHODIMP_(type) STDMETHODIMP_(type)
...
# define STDOVERRIDEMETHODIMPV_(type) STDMETHODIMPV_(type)
#endif

#define DEPRECATED_STDAPI(message)           EXTERN_C __ATTR_DEPRECATED_MSG(message) HRESULT STDAPICALLTYPE
#define DEPRECATED_NO_MESSAGE_STDAPI         EXTERN_C __ATTR_DEPRECATED HRESULT STDAPICALLTYPE
#define DEPRECATED_STDAPI_(type, message)    EXTERN_C __ATTR_DEPRECATED_MSG(message) type STDAPICALLTYPE
#define DEPRECATED_NO_MESSAGE_STDAPI_(type)  EXTERN_C __ATTR_DEPRECATED type STDAPICALLTYPE
#define DEPRECATED_STDAPIV(message)          EXTERN_C __ATTR_DEPRECATED_MSG(message) HRESULT STDAPIVCALLTYPE
#define DEPRECATED_NO_MESSAGE_STDAPIV        EXTERN_C __ATTR_DEPRECATED HRESULT STDAPIVCALLTYPE
#define DEPRECATED_STDAPIV_(type, message)   EXTERN_C __ATTR_DEPRECATED_MSG(message) type STDAPIVCALLTYPE
#define DEPRECATED_NO_MESSAGE_STDAPIV_(type) EXTERN_C __ATTR_DEPRECATED type STDAPIVCALLTYPE
...
#define InterlockedDecrementSizeTNoFence(a)      InterlockedDecrement64((LONG64 *)a)
  ...
  /* BOOLEAN InterlockedCompareExchange128(LONG64 volatile *Destination, LONG64 ExchangeHigh, LONG64 ExchangeLow, LONG64 *ComparandResult); */
...
#define UnsignedMultiply128 _umul128
  ...
  __MINGW_EXTENSION DWORD64 __readgsqword(DWORD Offset);
  ...
  __MINGW_EXTENSION VOID __writegsqword(DWORD Offset, DWORD64 Data);
#endif
...
#define ARM64_SYSREG(op0, op1, crn, crm, op2)   (((op0 & 1) << 14) | ((op1 & 7) << 11) | ((crn & 15) << 7) | ((crm & 15) << 3) | ((op2 & 7) << 0))
#define ARM64_SYSINSTR(op0, op1, crn, crm, op2) (((op1 & 7) << 11) | ((crn & 15) << 7) | ((crm & 15) << 3) | ((op2 & 7) << 0))
...
#define CONTEXT_ARM64_CONTROL         (CONTEXT_ARM64 | 0x01L)
#define CONTEXT_ARM64_INTEGER         (CONTEXT_ARM64 | 0x02L)
#define CONTEXT_ARM64_FLOATING_POINT  (CONTEXT_ARM64 | 0x04L)
#define CONTEXT_ARM64_DEBUG_REGISTERS (CONTEXT_ARM64 | 0x08L)
...
#pragma pop_macro("_DISPATCHER_CONTEXT_ARM64")
  ...
  struct _EXCEPTION_POINTERS;
  typedef LONG (*PEXCEPTION_FILTER)(struct _EXCEPTION_POINTERS *ExceptionPointers, DWORD64 EstablisherFrame);

  typedef VOID (*PTERMINATION_HANDLER)(BOOLEAN AbnormalTermination, DWORD64 EstablisherFrame);

  typedef PARM64_RUNTIME_FUNCTION GET_RUNTIME_FUNCTION_CALLBACK(DWORD64 ControlPc, PVOID Context);
  typedef GET_RUNTIME_FUNCTION_CALLBACK *PGET_RUNTIME_FUNCTION_CALLBACK;

  typedef DWORD OUT_OF_PROCESS_FUNCTION_TABLE_CALLBACK(HANDLE Process, PVOID TableAddress, PDWORD Entries, PARM64_RUNTIME_FUNCTION* Functions);
  typedef OUT_OF_PROCESS_FUNCTION_TABLE_CALLBACK *POUT_OF_PROCESS_FUNCTION_TABLE_CALLBACK;
...
#if !defined(_DBGRAISEASSERTIONFAILURE_) && !defined(RC_INVOKED) && !defined(__WIDL__)
...
extern "C" {
  ...
  FORCEINLINE
  CHAR ReadAcquire8(CHAR const volatile *Source)
  {
    CHAR Value;
    Value = *Source;
    return Value;
  ...
  FORCEINLINE
  CHAR ReadNoFence8(CHAR const volatile *Source)
  {
    CHAR Value;
    Value = *Source;
    return Value;
  ...
  FORCEINLINE
  VOID WriteRelease8(CHAR volatile *Destination, CHAR Value)
  {
    *Destination = Value;
    return;
  }
  ...
  FORCEINLINE
  VOID WriteNoFence8(CHAR volatile *Destination, CHAR Value)
  {
    *Destination = Value;
    return;
  }
  ...
  FORCEINLINE
  SHORT ReadAcquire16(SHORT const volatile *Source)
  {
    SHORT Value;
    Value = *Source;
    return Value;
  ...
  FORCEINLINE
  SHORT ReadNoFence16(SHORT const volatile *Source)
  {
    SHORT Value;
    Value = *Source;
    return Value;
  ...
  FORCEINLINE
  VOID WriteRelease16(SHORT volatile *Destination, SHORT Value)
  {
    *Destination = Value;
    return;
  }
  ...
  FORCEINLINE
  VOID WriteNoFence16(SHORT volatile *Destination, SHORT Value)
  {
    *Destination = Value;
    return;
  }
  ...
  FORCEINLINE
  LONG ReadAcquire(LONG const volatile *Source)
  {
    LONG Value;
    Value = *Source;
    return Value;
  ...
  CFORCEINLINE
  LONG ReadNoFence(LONG const volatile *Source)
  {
    LONG Value;
    Value = *Source;
    return Value;
  ...
  CFORCEINLINE
  VOID WriteRelease(LONG volatile *Destination, LONG Value)
  {
    *Destination = Value;
    return;
  }
  ...
  FORCEINLINE
  VOID WriteNoFence(LONG volatile *Destination, LONG Value)
  {
    *Destination = Value;
    return;
  }
  ...
  FORCEINLINE
  LONG64 ReadAcquire64(LONG64 const volatile *Source)
  {
    LONG64 Value;
    Value = *Source;
    return Value;
  ...
  CFORCEINLINE
  LONG64 ReadNoFence64(LONG64 const volatile *Source)
  {
    LONG64 Value;
    Value = *Source;
    return Value;
  ...
  CFORCEINLINE
  VOID WriteRelease64(LONG64 volatile *Destination, LONG64 Value)
  {
    *Destination = Value;
    return;
  }
  ...
  FORCEINLINE
  VOID WriteNoFence64(LONG64 volatile *Destination, LONG64 Value)
  {
    *Destination = Value;
    return;
  }
...
extern "C" {
  ...
  FORCEINLINE
  CHAR ReadRaw8(CHAR const volatile *Source)
  {
    CHAR Value;
    Value = *(CHAR *)Source;
    return Value;
  ...
  FORCEINLINE
  VOID WriteRaw8(CHAR volatile *Destination, CHAR Value)
  {
  ...
  FORCEINLINE
  SHORT ReadRaw16(SHORT const volatile *Source)
  {
    SHORT Value;
    Value = *(SHORT *)Source;
    return Value;
  ...
  FORCEINLINE
  VOID WriteRaw16(SHORT volatile *Destination, SHORT Value)
  {
  ...
  FORCEINLINE
  LONG ReadRaw(LONG const volatile *Source)
  {
    LONG Value;
    Value = *(LONG *)Source;
    return Value;
  ...
  CFORCEINLINE
  VOID WriteRaw(LONG volatile *Destination, LONG Value)
  {
  ...
  FORCEINLINE
  LONG64 ReadRaw64(LONG64 const volatile *Source)
  {
    LONG64 Value;
    Value = *(LONG64 *)Source;
    return Value;
  ...
  FORCEINLINE
  VOID WriteRaw64(LONG64 volatile *Destination, LONG64 Value)
  {
  ...
  FORCEINLINE
  LONG AddRaw(LONG volatile *Destination, LONG Value)
  {
    LONG NewValue;
  ...
  FORCEINLINE
  DWORD AddULongRaw(DWORD volatile *Destination, DWORD Value)
  {
    return (DWORD)AddRaw((PLONG)Destination, (LONG)Value);
  }

  FORCEINLINE
  LONG IncrementRaw(LONG volatile *Destination)
  {
    return AddRaw(Destination, 1);
  }

  FORCEINLINE
  DWORD IncrementULongRaw(DWORD volatile *Destination)
  {
    return (DWORD)IncrementRaw((PLONG)Destination);
  }

  FORCEINLINE
  BYTE ReadUCharAcquire(BYTE const volatile *Source)
  {
    return (BYTE)ReadAcquire8((PCHAR)Source);
  }

  FORCEINLINE
  BYTE ReadUCharNoFence(BYTE const volatile *Source)
  {
    return (BYTE)ReadNoFence8((PCHAR)Source);
  }

  FORCEINLINE
  BYTE ReadBooleanAcquire(BOOLEAN const volatile *Source)
  {
    return (BOOLEAN)ReadAcquire8((PCHAR)Source);
  }

  FORCEINLINE
  BYTE ReadBooleanNoFence(BOOLEAN const volatile *Source)
  {
    return (BOOLEAN)ReadNoFence8((PCHAR)Source);
  }

  FORCEINLINE
  BYTE ReadBooleanRaw(BOOLEAN const volatile *Source)
  {
    return (BOOLEAN)ReadRaw8((PCHAR)Source);
  }

  FORCEINLINE
  BYTE ReadUCharRaw(BYTE const volatile *Source)
  {
    return (BYTE)ReadRaw8((PCHAR)Source);
  }

  FORCEINLINE
  VOID WriteUCharRelease(BYTE volatile *Destination, BYTE Value)
  {
  ...
  FORCEINLINE
  VOID WriteUCharNoFence(BYTE volatile *Destination, BYTE Value)
  {
  ...
  FORCEINLINE
  VOID WriteBooleanRelease(BOOLEAN volatile *Destination, BOOLEAN Value)
  {
    WriteRelease8((PCHAR)Destination, (CHAR)Value);
    return;
  }
  ...
  FORCEINLINE
  VOID WriteBooleanNoFence(BOOLEAN volatile *Destination, BOOLEAN Value)
  {
    WriteNoFence8((PCHAR)Destination, (CHAR)Value);
    return;
  }
  ...
  FORCEINLINE
  VOID WriteUCharRaw(BYTE volatile *Destination, BYTE Value)
  {
  ...
  FORCEINLINE
  WORD ReadUShortAcquire(WORD const volatile *Source)
  {
    return (WORD)ReadAcquire16((PSHORT)Source);
  }

  FORCEINLINE
  WORD ReadUShortNoFence(WORD const volatile *Source)
  {
    return (WORD)ReadNoFence16((PSHORT)Source);
  }

  FORCEINLINE
  WORD ReadUShortRaw(WORD const volatile *Source)
  {
    return (WORD)ReadRaw16((PSHORT)Source);
  }

  FORCEINLINE
  VOID WriteUShortRelease(WORD volatile *Destination, WORD Value)
  {
  ...
  FORCEINLINE
  VOID WriteUShortNoFence(WORD volatile *Destination, WORD Value)
  {
  ...
  FORCEINLINE
  VOID WriteUShortRaw(WORD volatile *Destination, WORD Value)
  {
  ...
  FORCEINLINE
  DWORD ReadULongAcquire(DWORD const volatile *Source)
  {
    return (DWORD)ReadAcquire((PLONG)Source);
  }

  FORCEINLINE
  DWORD ReadULongNoFence(DWORD const volatile *Source)
  {
    return (DWORD)ReadNoFence((PLONG)Source);
  }

  FORCEINLINE
  DWORD ReadULongRaw(DWORD const volatile *Source)
  {
    return (DWORD)ReadRaw((PLONG)Source);
  }

  CFORCEINLINE
  VOID WriteULongRelease(DWORD volatile *Destination, DWORD Value)
  {
  ...
  FORCEINLINE
  VOID WriteULongNoFence(DWORD volatile *Destination, DWORD Value)
  {
  ...
  FORCEINLINE
  VOID WriteULongRaw(DWORD volatile *Destination, DWORD Value)
  {
  ...
  FORCEINLINE
  INT32 ReadInt32Acquire(INT32 const volatile *Source)
  {
    return (INT32)ReadAcquire((PLONG)Source);
  }

  FORCEINLINE
  INT32 ReadInt32NoFence(INT32 const volatile *Source)
  {
    return (INT32)ReadNoFence((PLONG)Source);
  }

  FORCEINLINE
  INT32 ReadInt32Raw(INT32 const volatile *Source)
  {
    return (INT32)ReadRaw((PLONG)Source);
  }

  CFORCEINLINE
  VOID WriteInt32Release(INT32 volatile *Destination, INT32 Value)
  {
    WriteRelease((PLONG)Destination, (LONG)Value);
    return;
  }
  ...
  FORCEINLINE
  VOID WriteInt32NoFence(INT32 volatile *Destination, INT32 Value)
  {
    WriteNoFence((PLONG)Destination, (LONG)Value);
    return;
  }
  ...
  FORCEINLINE
  VOID WriteInt32Raw(INT32 volatile *Destination, INT32 Value)
  {
    WriteRaw((PLONG)Destination, (LONG)Value);
    return;
  }
  ...
  FORCEINLINE
  UINT32 ReadUInt32Acquire(UINT32 const volatile *Source)
  {
    return (UINT32)ReadAcquire((PLONG)Source);
  }

  FORCEINLINE
  UINT32 ReadUInt32NoFence(UINT32 const volatile *Source)
  {
    return (UINT32)ReadNoFence((PLONG)Source);
  }

  FORCEINLINE
  UINT32 ReadUInt32Raw(UINT32 const volatile *Source)
  {
    return (UINT32)ReadRaw((PLONG)Source);
  }

  CFORCEINLINE
  VOID WriteUInt32Release(UINT32 volatile *Destination, UINT32 Value)
  {
    WriteRelease((PLONG)Destination, (LONG)Value);
    return;
  }
  ...
  FORCEINLINE
  VOID WriteUInt32NoFence(UINT32 volatile *Destination, UINT32 Value)
  {
    WriteNoFence((PLONG)Destination, (LONG)Value);
    return;
  }
  ...
  FORCEINLINE
  VOID WriteUInt32Raw(UINT32 volatile *Destination, UINT32 Value)
  {
    WriteRaw((PLONG)Destination, (LONG)Value);
    return;
  }
  ...
  FORCEINLINE
  DWORD64 ReadULong64Acquire(DWORD64 const volatile *Source)
  {
    return (DWORD64)ReadAcquire64((PLONG64)Source);
  }

  FORCEINLINE
  DWORD64 ReadULong64NoFence(DWORD64 const volatile *Source)
  {
    return (DWORD64)ReadNoFence64((PLONG64)Source);
  }

  FORCEINLINE
  DWORD64 ReadULong64Raw(DWORD64 const volatile *Source)
  {
    return (DWORD64)ReadRaw64((PLONG64)Source);
  }

  CFORCEINLINE
  VOID WriteULong64Release(DWORD64 volatile *Destination, DWORD64 Value)
  {
  ...
  FORCEINLINE
  VOID WriteULong64NoFence(DWORD64 volatile *Destination, DWORD64 Value)
  {
  ...
  FORCEINLINE
  VOID WriteULong64Raw(DWORD64 volatile *Destination, DWORD64 Value)
  {
  ...
  FORCEINLINE
  LONG64 AddRaw64(LONG64 volatile *Destination, LONG64 Value)
  {
    LONG64 NewValue;
  ...
  FORCEINLINE
  DWORD64 AddULong64Raw(DWORD64 volatile *Destination, DWORD64 Value)
  {
    return (DWORD64)AddRaw64((PLONG64)Destination, (LONG64)Value);
  }

  FORCEINLINE
  LONG64 IncrementRaw64(LONG64 volatile *Destination)
  {
    return AddRaw64(Destination, 1);
  }

  FORCEINLINE
  DWORD64 IncrementULong64Raw(DWORD64 volatile *Destination)
  {
...
#define WriteSizeTRaw     WriteULongPtrRaw
  ...
  FORCEINLINE
  PVOID ReadPointerAcquire(PVOID const volatile *Source)
  {
    return (PVOID)ReadAcquire64((PLONG64)Source);
  }

  CFORCEINLINE
  PVOID ReadPointerNoFence(PVOID const volatile *Source)
  {
    return (PVOID)ReadNoFence64((PLONG64)Source);
  }

  FORCEINLINE
  PVOID ReadPointerRaw(PVOID const volatile *Source)
  {
    return (PVOID)ReadRaw64((PLONG64)Source);
  }

  FORCEINLINE
  VOID WritePointerRelease(PVOID volatile *Destination, PVOID Value)
  {
    WriteRelease64((PLONG64)Destination, (LONG64)Value);
    return;
  }
  ...
  FORCEINLINE
  VOID WritePointerNoFence(PVOID volatile *Destination, PVOID Value)
  {
    WriteNoFence64((PLONG64)Destination, (LONG64)Value);
    return;
  }
  ...
  FORCEINLINE
  VOID WritePointerRaw(PVOID volatile *Destination, PVOID Value)
  {
    WriteRaw64((PLONG64)Destination, (LONG64)Value);
    return;
  }
...
#endif  /* !defined(RC_INVOKED) && !defined(__WIDL__) */
...
#define IS_TARGET_UNWIND(f) ((f & EXCEPTION_TARGET_UNWIND))
...
# define SECURITY_SID_SIZE(SubAuthorityCount_) (sizeof(SID) - sizeof(DWORD) + (SubAuthorityCount_) * sizeof(DWORD))
...
#define SECURITY_CAPABILITY_APP_RID            (0x000000400L)
...
#define JOB_OBJECT_VALID_COMPLETION_FILTER ((1U << (JOB_OBJECT_MSG_MAXIMUM + 1)) - 1) - ((1U << JOB_OBJECT_MSG_MINIMUM) - 1L)
...
#define JOB_OBJECT_NOTIFICATION_LIMIT_VALID_FLAGS (JOB_OBJECT_LIMIT_JOB_READ_BYTES | JOB_OBJECT_LIMIT_JOB_WRITE_BYTES | JOB_OBJECT_LIMIT_JOB_TIME | JOB_OBJECT_LIMIT_JOB_MEMORY_LOW | \
                JOB_OBJECT_LIMIT_JOB_MEMORY_HIGH | JOB_OBJECT_LIMIT_CPU_RATE_CONTROL | JOB_OBJECT_LIMIT_IO_RATE_CONTROL | JOB_OBJECT_LIMIT_NET_RATE_CONTROL)
...
#define XSTATE_MASK_ALLOWED                 (XSTATE_MASK_LEGACY | XSTATE_MASK_AVX | XSTATE_MASK_MPX | XSTATE_MASK_AVX512 | XSTATE_MASK_IPT | XSTATE_MASK_PASID | \
                                            XSTATE_MASK_CET_U | XSTATE_MASK_AMX_TILE_CONFIG | XSTATE_MASK_AMX_TILE_DATA | XSTATE_MASK_LWP)
...
#endif
#define XSTATE_MASK_AMD64_LEGACY            (XSTATE_MASK_LEGACY_FLOATING_POINT | XSTATE_MASK_LEGACY_SSE)
...
#define IMAGE_DYNAMIC_RELOCATION_IMPORT_CONTROL_TRANSFER IMAGE_DYNAMIC_RELOCATION_GUARD_IMPORT_CONTROL_TRANSFER
  typedef IMAGE_IMPORT_CONTROL_TRANSFER_DYNAMIC_RELOCATION IMAGE_IMPORT_CONTROL_TRANSFER_RELOCATION, *PIMAGE_IMPORT_CONTROL_TRANSFER_RELOCATION;

#else

#define IMAGE_DYNAMIC_RELOCATION_IMPORT_CONTROL_TRANSFER IMAGE_DYNAMIC_RELOCATION_ARM64_KERNEL_IMPORT_CALL_TRANSFER
  typedef IMAGE_IMPORT_CONTROL_TRANSFER_ARM64_RELOCATION IMAGE_IMPORT_CONTROL_TRANSFER_RELOCATION, *PIMAGE_IMPORT_CONTROL_TRANSFER_RELOCATION;
...
#include <apiset.h>
  ...
  NTSYSAPI VOID NTAPI RtlCaptureContext(PCONTEXT ContextRecord) __RETURNS_TWICE;
#endif
...
# if WINAPI_FAMILY_PARTITION(WINAPI_PARTITION_APP | WINAPI_PARTITION_SYSTEM | WINAPI_PARTITION_GAMES)
  ...
  NTSYSAPI VOID             __cdecl RtlRestoreContext(PCONTEXT ContextRecord, struct _EXCEPTION_RECORD *ExceptionRecord) __NORETURN;
...
#if defined(_DBG_MEMCPY_INLINE_) && !defined(__WIDL__) && !defined(_MEMCPY_INLINE_) && !defined(_CRTBLD)
#define _MEMCPY_INLINE_
  FORCEINLINE
  PVOID __cdecl memcpy_inline(void *dst, const void *src, size_t size)
  {
...
#endif  /* defined(_DBG_MEMCPY_INLINE_) && !defined(__WIDL__) && !defined(_MEMCPY_INLINE_) && !defined(_CRTBLD) */
...
# endif  /* !defined(_WINBASE_) && !defined(__WIDL__) */
...
#define WRITE_NV_MEMORY_FLAG_PERSIST      (WRITE_NV_MEMORY_FLAG_FLUSH | WRITE_NV_MEMORY_FLAG_NON_TEMPORAL)
...
#define FILL_NV_MEMORY_FLAG_PERSIST      (FILL_NV_MEMORY_FLAG_FLUSH | FILL_NV_MEMORY_FLAG_NON_TEMPORAL)
#define FILL_NV_MEMORY_FLAG_NO_DRAIN     (0x00000100)

  NTSYSAPI DWORD NTAPI RtlGetNonVolatileToken(PVOID NvBuffer, SIZE_T Size, PVOID *NvToken);
  NTSYSAPI DWORD NTAPI RtlFreeNonVolatileToken(PVOID NvToken);
  NTSYSAPI DWORD NTAPI RtlFlushNonVolatileMemory(PVOID NvToken, PVOID NvBuffer, SIZE_T Size, DWORD Flags);
  NTSYSAPI DWORD NTAPI RtlDrainNonVolatileFlush(PVOID NvToken);
  NTSYSAPI DWORD NTAPI RtlWriteNonVolatileMemory(PVOID NvToken, VOID UNALIGNED *NvDestination, CONST VOID UNALIGNED *Source, SIZE_T Size, DWORD Flags);
  NTSYSAPI DWORD NTAPI RtlFillNonVolatileMemory(PVOID NvToken, VOID UNALIGNED *NvDestination, SIZE_T Size, CONST BYTE Value, DWORD Flags);
  NTSYSAPI DWORD NTAPI RtlFlushNonVolatileMemoryRanges(PVOID NvToken, PNV_MEMORY_RANGE NvRanges, SIZE_T NumRanges, DWORD Flags);
...
#define TraceLoggingCORRELATION_VECTOR(cv) TraceLoggingString((cv).Vector, "__TlgCV__")
  ...
  NTSYSAPI DWORD NTAPI RtlInitializeCorrelationVector(PCORRELATION_VECTOR CorrelationVector, int Version, const GUID *Guid);
  NTSYSAPI DWORD NTAPI RtlIncrementCorrelationVector(PCORRELATION_VECTOR CorrelationVector);
  NTSYSAPI DWORD NTAPI RtlExtendCorrelationVector(PCORRELATION_VECTOR CorrelationVector);
  NTSYSAPI DWORD NTAPI RtlValidateCorrelationVector(PCORRELATION_VECTOR Vector);
...
#ifndef __WIDL__
  FORCEINLINE
  VOID CUSTOM_SYSTEM_EVENT_TRIGGER_INIT(PCUSTOM_SYSTEM_EVENT_TRIGGER_CONFIG Config, PCWSTR TriggerId)
  {
  ...
  DWORD NTAPI RtlRaiseCustomSystemEventTrigger(PCUSTOM_SYSTEM_EVENT_TRIGGER_CONFIG TriggerConfig);
...
#define IMAGE_POLICY_BOOL(_PolicyId_, _Value_)           {ImagePolicyEntryTypeBool, _PolicyId_, (const VOID *)_Value_},
#define IMAGE_POLICY_INT8(_PolicyId_, _Value_)           {ImagePolicyEntryTypeInt8, _PolicyId_, (const VOID *)_Value_},
#define IMAGE_POLICY_UINT8(_PolicyId_, _Value_)          {ImagePolicyEntryTypeUInt8, _PolicyId_, (const VOID *)_Value_},
#define IMAGE_POLICY_INT16(_PolicyId_, _Value_)          {ImagePolicyEntryTypeInt16, _PolicyId_, (const VOID *)_Value_},
#define IMAGE_POLICY_UINT16(_PolicyId_, _Value_)         {ImagePolicyEntryTypeUInt16, _PolicyId_, (const VOID *)_Value_},
#define IMAGE_POLICY_INT32(_PolicyId_, _Value_)          {ImagePolicyEntryTypeInt32, _PolicyId_, (const VOID *)_Value_},
#define IMAGE_POLICY_UINT32(_PolicyId_, _Value_)         {ImagePolicyEntryTypeUInt32, _PolicyId_, (const VOID *)_Value_},
#define IMAGE_POLICY_INT64(_PolicyId_, _Value_)          {ImagePolicyEntryTypeInt64, _PolicyId_, (const VOID *)_Value_},
#define IMAGE_POLICY_UINT64(_PolicyId_, _Value_)         {ImagePolicyEntryTypeUInt64, _PolicyId_, (const VOID *)_Value_},
#define IMAGE_POLICY_ANSI_STRING(_PolicyId_, _Value_)    {ImagePolicyEntryTypeAnsiString, _PolicyId_, _Value_},
#define IMAGE_POLICY_UNICODE_STRING(_PolicyId_, _Value_) {ImagePolicyEntryTypeUnicodeString, _PolicyId_, _Value_},
#define IMAGE_POLICY_OVERRIDE(_PolicyId_)                {ImagePolicyEntryTypeOverride, _PolicyId_, 0},

  NTSYSAPI BOOLEAN NTAPI RtlIsZeroMemory(PVOID Buffer, SIZE_T Length);
  NTSYSAPI BOOLEAN NTAPI RtlNormalizeSecurityDescriptor(PSECURITY_DESCRIPTOR *SecurityDescriptor, DWORD SecurityDescriptorLength, PSECURITY_DESCRIPTOR *NewSecurityDescriptor, PDWORD NewSecurityDescriptorLength, BOOLEAN CheckOnly);
...
#define RTL_VIRTUAL_UNWIND2_VALIDATE_PAC 0x00000001UL
  ...
  NTSYSAPI DWORD NTAPI RtlGetSystemGlobalData(RTL_SYSTEM_GLOBAL_DATA_ID DataId, PVOID Buffer, DWORD Size);
  NTSYSAPI DWORD NTAPI RtlSetSystemGlobalData(RTL_SYSTEM_GLOBAL_DATA_ID DataId, PVOID Buffer, DWORD Size);
...
#define DEVICEFAMILYDEVICEFORM_MAX                   0x0000002D
  ...
  VOID  NTAPI RtlGetDeviceFamilyInfoEnum(ULONGLONG *pullUAPInfo, DWORD *pulDeviceFamily, DWORD *pulDeviceForm);
  DWORD NTAPI RtlConvertDeviceFamilyInfoToString(PDWORD pulDeviceFamilyBufferSize, PDWORD pulDeviceFormBufferSize, PWSTR DeviceFamily, PWSTR DeviceForm);
  DWORD NTAPI RtlSwitchedVVI(PRTL_OSVERSIONINFOEXW VersionInfo, DWORD TypeMask, ULONGLONG ConditionMask);
...
#define CM_SERVICE_VALID_PROMOTION_MASK (CM_SERVICE_NETWORK_BOOT_LOAD | CM_SERVICE_VIRTUAL_DISK_BOOT_LOAD | CM_SERVICE_USB_DISK_BOOT_LOAD | CM_SERVICE_SD_DISK_BOOT_LOAD | \
                                        CM_SERVICE_USB3_DISK_BOOT_LOAD | CM_SERVICE_MEASURED_BOOT_LOAD | CM_SERVICE_VERIFIER_BOOT_LOAD | CM_SERVICE_WINPE_BOOT_LOAD | CM_SERVICE_RAM_DISK_BOOT_LOAD)
...
#define ENLISTMENT_ALL_ACCESS      (STANDARD_RIGHTS_REQUIRED | ENLISTMENT_GENERIC_READ | ENLISTMENT_GENERIC_WRITE | ENLISTMENT_GENERIC_EXECUTE)
  ...
  typedef VOID NTAPI          TP_SIMPLE_CALLBACK(PTP_CALLBACK_INSTANCE Instance, PVOID Context);
  ...
  typedef VOID NTAPI                        TP_CLEANUP_GROUP_CANCEL_CALLBACK(PVOID ObjectContext, PVOID CleanupContext);
  ...
  typedef TP_CALLBACK_ENVIRON_V3 TP_CALLBACK_ENVIRON, *PTP_CALLBACK_ENVIRON;
    ...
    FORCEINLINE
    VOID TpSetCallbackActivationContext(PTP_CALLBACK_ENVIRON cbe, struct _ACTIVATION_CONTEXT *actx)
    {
    ...
    FORCEINLINE
    VOID TpSetCallbackPriority(PTP_CALLBACK_ENVIRON cbe, TP_CALLBACK_PRIORITY prio)
    {
  ...
  typedef VOID NTAPI        TP_WORK_CALLBACK(PTP_CALLBACK_INSTANCE Instance, PVOID Context, PTP_WORK Work);
  typedef TP_WORK_CALLBACK *PTP_WORK_CALLBACK;

  typedef struct _TP_TIMER TP_TIMER, *PTP_TIMER;

  typedef VOID NTAPI         TP_TIMER_CALLBACK(PTP_CALLBACK_INSTANCE Instance, PVOID Context, PTP_TIMER Timer);
  typedef TP_TIMER_CALLBACK *PTP_TIMER_CALLBACK;

  typedef DWORD           TP_WAIT_RESULT;
  typedef struct _TP_WAIT TP_WAIT, *PTP_WAIT;

  typedef VOID NTAPI        TP_WAIT_CALLBACK(PTP_CALLBACK_INSTANCE Instance, PVOID Context, PTP_WAIT Wait, TP_WAIT_RESULT WaitResult);
  ...
  __MINGW_EXTENSION
  __forceinline
  unsigned __int64 NtReadCurrentTebUlongPtr(unsigned int Offset)
  {
  ...
  __MINGW_EXTENSION
  __forceinline
  unsigned __int64 NtReadCurrentTebUlonglong(unsigned int Offset)
  {
    return __readgsqword(Offset);
  }
...
#endif  /* defined(__aarch64__) && !defined(__WIDL__) */
