...
#define DEPRECATED_STDAPI(message)           EXTERN_C __MINGW_DEPRECATED_MSG(message) HRESULT STDAPICALLTYPE
#define DEPRECATED_NO_MESSAGE_STDAPI         EXTERN_C __declspec(deprecated) HRESULT STDAPICALLTYPE
#define DEPRECATED_STDAPI_(type, message)    EXTERN_C __MINGW_DEPRECATED_MSG(message) type STDAPICALLTYPE
#define DEPRECATED_NO_MESSAGE_STDAPI_(type)  EXTERN_C __declspec(deprecated) type STDAPICALLTYPE
#define DEPRECATED_STDAPIV(message)          EXTERN_C __MINGW_DEPRECATED_MSG(message) HRESULT STDAPIVCALLTYPE
#define DEPRECATED_NO_MESSAGE_STDAPIV        EXTERN_C __declspec(deprecated) HRESULT STDAPIVCALLTYPE
#define DEPRECATED_STDAPIV_(type, message)   EXTERN_C __MINGW_DEPRECATED_MSG(message) type STDAPIVCALLTYPE
...
#include <apiset.h>
  ...
  NTSYSAPI VOID NTAPI RtlCaptureContext(PCONTEXT ContextRecord) __MINGW_RETURN_TWICE;
#endif
