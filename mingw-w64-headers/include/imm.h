...
#define ImmGetCompositionString __MINGW_NAME_AW(ImmGetCompositionString)
  WINBOOL WINAPI ImmSetCompositionStringA(HIMC, DWORD dwIndex, LPVOID lpComp, DWORD dwCompLen, LPVOID lpRead, DWORD dwReadLen);
  WINBOOL WINAPI ImmSetCompositionStringW(HIMC, DWORD dwIndex, LPVOID lpComp, DWORD dwCompLen, LPVOID lpRead, DWORD dwReadLen);
...
#define ImmGetGuideLine __MINGW_NAME_AW(ImmGetGuideLine)
  WINBOOL WINAPI ImmGetConversionStatus(HIMC, LPDWORD lpfdwConversion, LPDWORD lpfdwSentence);
  ...
  WINBOOL WINAPI ImmGetCompositionFontA(HIMC, LPLOGFONTA lplf);
  WINBOOL WINAPI ImmGetCompositionFontW(HIMC, LPLOGFONTW lplf);
#define ImmGetCompositionFont __MINGW_NAME_AW(ImmGetCompositionFont)
  WINBOOL WINAPI ImmSetCompositionFontA(HIMC, LPLOGFONTA lplf);
  WINBOOL WINAPI ImmSetCompositionFontW(HIMC, LPLOGFONTW lplf);
...
#define ImmGetConversionList __MINGW_NAME_AW(ImmGetConversionList)
  ...
  WINBOOL WINAPI ImmGetStatusWindowPos(HIMC, LPPOINT lpptPos);
  WINBOOL WINAPI ImmSetStatusWindowPos(HIMC, LPPOINT lpptPos);
  WINBOOL WINAPI ImmGetCompositionWindow(HIMC, LPCOMPOSITIONFORM lpCompForm);
  WINBOOL WINAPI ImmSetCompositionWindow(HIMC, LPCOMPOSITIONFORM lpCompForm);
  WINBOOL WINAPI ImmGetCandidateWindow(HIMC, DWORD, LPCANDIDATEFORM lpCandidate);
  WINBOOL WINAPI ImmSetCandidateWindow(HIMC, LPCANDIDATEFORM lpCandidate);
...
#define ImmGetImeMenuItems __MINGW_NAME_AW(ImmGetImeMenuItems)
  ...
  WINBOOL WINAPI ImmDisableLegacyIME(void);
