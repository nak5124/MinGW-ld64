...
#define PROPSHEETPAGE_V4        __MINGW_NAME_AW_EXT(PROPSHEETPAGE,    _V4)
#define LPPROPSHEETPAGE_V4      __MINGW_NAME_AW_EXT(LPPROPSHEETPAGE,  _V4)
#define LPCPROPSHEETPAGE_V4     __MINGW_NAME_AW_EXT(LPCPROPSHEETPAGE, _V4)
...
#define PropSheet_Changed(hDlg, hwnd)                 SNDMSG(hDlg, PSM_CHANGED, (WPARAM)(hwnd), (LPARAM)0L)
#define PSM_RESTARTWINDOWS                            (WM_USER + 105)
#define PropSheet_RestartWindows(hDlg)                SNDMSG(hDlg, PSM_RESTARTWINDOWS, (WPARAM)0, (LPARAM)0L)
#define PSM_REBOOTSYSTEM                              (WM_USER + 106)
#define PropSheet_RebootSystem(hDlg)                  SNDMSG(hDlg, PSM_REBOOTSYSTEM, (WPARAM)0, (LPARAM)0L)
#define PSM_CANCELTOCLOSE                             (WM_USER + 107)
#define PropSheet_CancelToClose(hDlg)                 PostMessage(hDlg, PSM_CANCELTOCLOSE, (WPARAM)0, (LPARAM)0L)
#define PSM_QUERYSIBLINGS                             (WM_USER + 108)
#define PropSheet_QuerySiblings(hDlg, wParam, lParam) SNDMSG(hDlg, PSM_QUERYSIBLINGS, wParam, lParam)
#define PSM_UNCHANGED                                 (WM_USER + 109)
#define PropSheet_UnChanged(hDlg, hwnd)               SNDMSG(hDlg, PSM_UNCHANGED, (WPARAM)(hwnd), (LPARAM)0L)
#define PSM_APPLY                                     (WM_USER + 110)
#define PropSheet_Apply(hDlg)                         SNDMSG(hDlg, PSM_APPLY, (WPARAM)0, (LPARAM)0L)
...
#define PropSheet_GetCurrentPageHwnd(hDlg)                 (HWND)SNDMSG(hDlg, PSM_GETCURRENTPAGEHWND, (WPARAM)0, (LPARAM)0L)
