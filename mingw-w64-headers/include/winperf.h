...
#define PERF_NO_UNIQUE_ID -1
  ...
  typedef DWORD (APIENTRY PM_OPEN_PROC)(LPWSTR pContext);
  typedef DWORD (APIENTRY PM_COLLECT_PROC)(LPWSTR pValueName, void **ppData, DWORD *pcbTotalBytes, DWORD *pNumObjectTypes);
