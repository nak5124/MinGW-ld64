...
extern _tzset_func __IMP_SYMBOL(_tzset);
...
char** __IMP_SYMBOL(tzname) = initial_tznames;
long * __IMP_SYMBOL(timezone) = &initial_timezone;
int * __IMP_SYMBOL(daylight) = &initial_daylight;
...
void __cdecl _tzset(void)
{
  ...
  __IMP_SYMBOL(tzname) = _tzname;
  __IMP_SYMBOL(timezone) = __timezone();
  __IMP_SYMBOL(daylight) = __daylight();
}
...
void __cdecl (*__IMP_SYMBOL(tzset))(void) = tzset;
