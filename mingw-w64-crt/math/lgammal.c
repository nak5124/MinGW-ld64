...
extern long double __attribute__((alias(__MINGW64_STRINGIFY(__MINGW_IMP_SYMBOL(lgamma)))))
  (__cdecl *__MINGW_IMP_SYMBOL(lgammal))(long double x);
#else
...
/* Reentrant version */
static long double __lgammal_r(long double x, int* sgngaml);
